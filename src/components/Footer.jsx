      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <div className="footer__logo">
            <span className="footer__logo-icon">MA</span>
            <span className="footer__logo-text">Muhammad Abriq</span>
          </div>
          <p className="footer__tagline">Python Engineer · AI/LLMs · FastAPI · RAG Systems</p>
          <p className="footer__copy">© {year} Muhammad Abriq. All rights reserved.</p>
        </div>
        ...
        <div className="footer__right">
          <div className="footer__socials">
            ...
            <a href={`https://wa.me/${profile.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="WhatsApp">
            ...
            <a href={`mailto:${profile.email}`} className="footer__social" aria-label="Email">
